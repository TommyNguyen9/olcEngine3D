...
private:
    ...
    mat4x4 Matrix_PointAt(vec3d& pos, vec3d& target, vec3d& up)
    {
        ...
        // Constructing Dimensioning & Translation Matrix:
        mat4x4 matrix;
    ...
    mat4x4 Matrix_QuickInverse(mat4x4& m) // Rotation/Translation Matrices only!
    {
        mat4x4 matrix;
    ...
    {
        // Plane normal needs to be normal
        plane_n = Vector_Normalise(plane_n);
        ...
        // 2 temp storage arrays to classify points either side of plane
        ...
        {
            // All points lie on inside of plane. Do nothing.
            // Allow triangle to pass through
            out_tri1 = in_tri;
...
public:
    ...
    bool OnUserUpdate(float fElapsedTime) override
    {
        ...
        for (auto tri : meshCube.tris)
        {
            ...
            // Cross product of lines to get normal to triangle surface
            ...
            // If ray is alligned with normal, triangle is visible:
            if (Vector_DotProduct(normal, vCameraRay) < 0.0f)
            {
                ...
                // How alligned are the light direction & triangle surface normal?
